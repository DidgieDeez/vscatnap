	...
	override function create()
	{
		...
		for (i in 0...WeekData.weeksList.length)
		{
			...
			if(!isLocked || !weekFile.hiddenUntilUnlocked)
			{
				...
				var weekThing:WeekItem = new WeekItem(0, bgSprite.y + 396, WeekData.weeksList[i]);
				weekThing.x += ((weekThing.width + 40) * num);
		...
		leftArrow = new FlxSprite(grpWeekText.members[0].x - 20, grpWeekText.members[0].y + 10);
		...
		rightArrow = new FlxSprite(grpWeekText.members[0].x + grpWeekText.members[0].width + 10, leftArrow.y);
