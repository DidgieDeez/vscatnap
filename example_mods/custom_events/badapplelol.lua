function onCreatePost()
	local og1 = getProperty('healthBar.leftBar.color')
	local og2 = getProperty('healthBar.rightBar.color')
	makeLuaSprite('whitebg', '', 0, 0)
	setScrollFactor('whitebg', 0, 0)
	makeGraphic('whitebg', 3840, 2160, '9700FF')
...
function onEvent(n, v1, v2)
	...
	if n == 'badapplelol' and string.lower(v1) == 'b' then
		...
		doTweenColor('badapplexd7', 'healthBar', og1, v2, 'linear')
