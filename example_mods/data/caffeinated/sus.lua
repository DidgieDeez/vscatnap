...
function onCreate()
	...
	makeGraphic('JukeBox', 300, 200, '0')
	setObjectCamera('JukeBox', 'hud')
	addLuaSprite('JukeBox', true)
	
	--the text for the "song name" bit
	makeLuaText('JukeBoxText', '@metalfaceterry @BrenTheCat', 300, -305-IntroTagWidth, 180)
	...
	makeLuaText('JukeBoxSubText', 'Caffeinated', 300, -305-IntroTagWidth, 230)
	setTextAlignment('JukeBoxSubText', 'center')
	setObjectCamera('JukeBoxSubText', 'other')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
	addLuaText('JukeBoxSubText')
	setProperty('JukeBoxSubText.color', getColorFromHex('FF8300'))
end
