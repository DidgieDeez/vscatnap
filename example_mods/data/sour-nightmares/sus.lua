...
function onCreate()
	...
	setObjectCamera('JukeBox', 'game')
	addLuaSprite('JukeBox', true)
	
	--the text for the "song name" bit
	makeLuaText('JukeBoxText', '@Logger', 350, -305-IntroTagWidth, 180)
	...
	makeLuaText('JukeBoxSubText', 'Sour Nightmares', 390, -305-IntroTagWidth, 210)
