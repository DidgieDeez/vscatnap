...
function onCreate()
	...
	makeLuaText('JukeBoxText', '@BrenTheCat', 300, -305-IntroTagWidth, 180)
	...
	makeLuaText('JukeBoxSubText', 'Control', 300, -305-IntroTagWidth, 210)
	setTextAlignment('JukeBoxSubText', 'center')
	setObjectCamera('JukeBoxSubText', 'other')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
	addLuaText('JukeBoxSubText')
	setProperty('JukeBoxSubText.color', getColorFromHex('FF004E'))
end
