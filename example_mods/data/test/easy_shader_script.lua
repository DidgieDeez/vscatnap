...
function onCreatePost()
    ...
    makeShader('radialBlur', {'game'})
    makeControl('radialBlur', 'blurWidth', 10) --radialBlur,blurWidth
    setShaderFloat('radialBlur', 'cx', 10)
    setShaderFloat('radialBlur', 'cy', 10)

    makeShader('bloom', {'game', 'hud'})
    makeControl('bloom', 'u_brightness', 0) --bloom,u_brightness

    setShaderFloatArray('bloom', 'u_samples', {8, 8})
