...
function onCreate()
	...
	makeLuaText('JukeBoxText', '@Roku_Hyaku', 240, -305-IntroTagWidth, 180)
	...
	makeLuaText('JukeBoxSubText', 'Doggone Happy', 350, -305-IntroTagWidth, 210)
...
function onTimerCompleted(tag, loops, loopsLeft)
	...
	if tag == 'JukeBoxWait' then
		doTweenX('MoveOutOne', 'JukeBoxTag', -550, 1.5, 'CircInOut')
		doTweenX('MoveOutTwo', 'JukeBox', -550, 1.5, 'CircInOut')
		doTweenX('MoveOutThree', 'JukeBoxText', -550, 1.5, 'CircInOut')
		doTweenX('MoveOutFour', 'JukeBoxSubText', -550, 1.5, 'CircInOut')
	end
end